...
def capture_and_decode():
    ...
    # Note: Not all webcams support this setting; it may require adjustment
    autofocus_property = cv2.CAP_PROP_AUTOFOCUS  # Autofocus property for OpenCV
    if autofocus_property in dir(cv2):  # Check if the property exists
